export const terms = (
  <>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Mind Mirror.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Mind Mirror, accessible from{" "}
          <a
            href="www.mindmirror.com"
    ...
    <ul>
      <li>By email: kshsiaan@gmail.com</li>
    </ul>
  </>
);
